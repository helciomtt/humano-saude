    ...
    <section id="duvidas" className="py-20 sm:py-32 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-20">
          <div className="inline-block px-6 py-2 rounded-full border border-[#B8941F]/20 bg-[#B8941F]/10 text-xs tracking-widest text-[#B8941F] font-bold mb-6 uppercase">
            Dúvidas frequentes
          </div>
          <h2 className="text-3xl md:text-4xl font-black mb-4 text-black leading-[1.1]">
        ...
        <div className="text-center mt-16">
          <a
            ...
            className="inline-flex items-center gap-2 bg-black hover:bg-gray-900 px-10 py-4 rounded-xl text-xs uppercase tracking-widest font-black text-white transition-all"
          >
