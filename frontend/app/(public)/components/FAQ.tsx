    ...
    <section id="duvidas" className="py-20 sm:py-32 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6">
        <div className="text-center mb-20">
          <div className="inline-block px-6 py-2 rounded-full border border-gold-200 bg-gold-50 text-xs tracking-widest text-gold-400 font-bold mb-6 uppercase">
            Dúvidas Frequentes
          </div>
          <h2 className="text-4xl md:text-5xl font-black mb-4 text-black leading-[1.1]">
