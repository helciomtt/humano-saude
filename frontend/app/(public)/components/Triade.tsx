...
export default function Triade() {
  ...
  return (
    <section id="metodo" className="py-20 sm:py-32 bg-white text-center">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-black mb-6">
          A Tríade Humana
        </h2>
        <div className="w-24 h-1.5 bg-gold-400 mx-auto mb-20" />

        <div id="timeline-container" ref={containerRef} className="relative pl-10 md:pl-40 text-left mb-20">
          {/* Linha vertical */}
          <div className="absolute left-8 md:left-20 top-0 bottom-0 w-[2px] bg-gray-200">
            <div
              className="bg-gold-400 w-full transition-all duration-300 ease-out"
          ...
          <div className="space-y-40">
            ...
            <div className="relative">
              <div className="absolute -left-12 md:-left-28 top-0 h-12 w-12 md:h-16 md:w-16 border-2 border-gold-400/30 bg-white rounded-full flex items-center justify-center font-bold text-xs md:text-lg text-gray-900 shadow-xl">
                01
              </div>
              <h3 className="text-2xl font-bold text-gold-400 mb-4 text-left">
                Analisar
              </h3>
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-black hover:bg-gray-900 px-12 py-5 rounded-xl text-sm uppercase tracking-widest mt-12 font-black text-white transition-all"
        >
